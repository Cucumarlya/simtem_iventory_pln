    ...
    <nav class="menu">
        ...
        @if ($userRole === 'admin')
            <a href="{{ route('dashboard.admin') }}"
                class="menu-item {{ request()->routeIs('dashboard.admin') ? 'active' : '' }}">
                <ion-icon name="home-outline"></ion-icon>
                <span>Dashboard</span>
            </a>
        @elseif($userRole === 'petugas')
            <a href="{{ route('dashboard.petugas') }}"
                class="menu-item {{ request()->routeIs('dashboard.petugas') ? 'active' : '' }}">
                <ion-icon name="home-outline"></ion-icon>
                <span>Dashboard</span>
            </a>
        ...
        @if ($userRole === 'admin')
            ...
            <a href="{{ route('material.index') }}"
                class="menu-item {{ request()->routeIs('material.*') ? 'active' : '' }}">
                <ion-icon name="cube-outline"></ion-icon>
                <span>Master Material</span>
            </a>
            <a href="{{ route('transaksi.index') }}"
                class="menu-item {{ request()->routeIs('transaksi.*') ? 'active' : '' }}">
                <ion-icon name="swap-horizontal-outline"></ion-icon>
                <span>Transaksi Material</span>
            </a>
            <a href="{{ route('stok-material.index') }}"
                class="menu-item {{ request()->routeIs('stok-material.*') ? 'active' : '' }}">
        ...
        @if ($userRole === 'petugas')
            <a href="{{ route('transaksi.penerimaan.create') }}"
                class="menu-item {{ request()->routeIs('transaksi.penerimaan.*') ? 'active' : '' }}">
                <ion-icon name="arrow-down-outline"></ion-icon>
                <span>Buat Penerimaan</span>
            </a>

            <a href="{{ route('transaksi.pengeluaran.create') }}"
                class="menu-item {{ request()->routeIs('transaksi.pengeluaran.*') ? 'active' : '' }}">
                <ion-icon name="arrow-up-outline"></ion-icon>
                <span>Buat Pengeluaran</span>
            </a>

            <a href="{{ route('transaksi.index') }}"
                class="menu-item {{ request()->routeIs('transaksi.index') ? 'active' : '' }}">
