                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Histori transaksi material yang telah disetujui dan dikembalikan</p>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                            ...
                            <div class="flex gap-2 mb-3 md:mb-0 md:mr-4">
                                <button class="px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors flex items-center text-sm font-medium"
                                        title="Export to Excel" onclick="alert('Fitur export akan aktif saat data real tersedia')">
                                    <i class="fas fa-file-excel mr-2"></i> Excel
                                </button>
                                
                                <button class="px-4 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors flex items-center text-sm font-medium"
                                        title="Export to PDF" onclick="alert('Fitur export akan aktif saat data real tersedia')">
                            ...
                            <div class="overflow-x-auto rounded-lg border border-gray-200">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($penerimaanData as $index => $transaksi)
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                @php
                                                    ...
                                                    $text = $statusText[$transaksi['status']] ?? ucfirst($transaksi['status']);
                                                @endphp
                                                {{ $text }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex flex-wrap gap-2">
                                                    ...
                                                    @php
                                                        ...
                                                        if ($transaksi['status'] == 'disetujui' && $transaksi['input_oleh'] == 'admin') {
                                                    ...
                                                    <!-- TOMBOL HAPUS (MERAH) -->
                                                    <form method="POST" action="{{ route('admin.transaksi.destroy', $transaksi['id']) }}" class="inline delete-form">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" 
                                ...
                                <div class="text-center py-12">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada data penerimaan</h3>
                                    <p class="text-gray-500 mb-6">Mulai dengan menambahkan data penerimaan material baru</p>
                                    <a href="{{ route('admin.transaksi.create', ['jenis' => 'penerimaan']) }}" 
                                       class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        ...
                        <div id="tab-pengeluaran" class="tab-pane hidden">
                            <div class="overflow-x-auto rounded-lg border border-gray-200">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($pengeluaranData as $index => $transaksi)
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center">
                                                {{ $index + 1 }}
                                            </td>
                                ...
                                <div class="text-center py-12">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada data pengeluaran</h3>
                                    <p class="text-gray-500 mb-6">Mulai dengan menambahkan data pengeluaran material baru</p>
