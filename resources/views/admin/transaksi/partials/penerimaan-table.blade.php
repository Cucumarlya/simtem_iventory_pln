<!-- resources/views/admin/transaksi/partials/penerimaan-table.blade.php -->
...
<div class="overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ ($penerimaan->currentPage() - 1) * $penerimaan->perPage() + $loop->iteration }}</td>
    ...
    @if($penerimaan->count())
    <div class="mt-4">
        {{ $penerimaan->appends(['tab' => 'penerimaan', 'search' => request('search'), 'status' => request('status')])->links() }}
    </div>
    @endif
</div>
