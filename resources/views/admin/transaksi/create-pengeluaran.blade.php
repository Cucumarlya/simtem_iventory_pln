<!-- resources/views/admin/transaksi/create-pengeluaran.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                    Form untuk menambahkan pengeluaran material baru
                </p>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.transaksi.store') }}" enctype="multipart/form-data" id="formTransaksi">
                    ...
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Isi form berikut untuk menambahkan pengeluaran material</p>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="flex justify-between items-center mb-4">
                                <h4 class="text-sm font-medium text-gray-700">Material yang Dikeluarkan</h4>
                                <button type="button" 
                                        class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 flex items-center transition-colors" 
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div>
                                            ...
                                            <select name="material[0][id]" 
                                                    class="material-select w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="material[0][jumlah]" 
                                                   class="material-jumlah w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" 
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <!-- SR Sebelum -->
                                <div>
                                    <label for="foto_sr_sebelum" class="block text-sm font-medium text-gray-700 mb-1">
                                        Foto SR Sebelum
                                    </label>
                                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-500 transition-colors cursor-pointer relative">
                                        <div class="text-gray-400 mb-3">
                                            <i class="fas fa-camera text-2xl"></i>
                                        </div>
                                        <div class="font-medium text-gray-700 mb-1">Upload Foto</div>
                                ...
                                <!-- SR Setelah -->
                                <div>
                                    <label for="foto_sr_sesudah" class="block text-sm font-medium text-gray-700 mb-1">
                                        Foto SR Setelah
                                    </label>
                                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-500 transition-colors cursor-pointer relative">
                                        <div class="text-gray-400 mb-3">
                                ...
                                <div>
                                    ...
                                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-500 transition-colors cursor-pointer relative">
                                        ...
                                        <div class="font-medium text-gray-700 mb-1">Upload Foto</div>
                                        <div class="text-sm text-gray-500">Wajib diisi</div>
                        ...
                        <div class="flex justify-end gap-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors flex items-center">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('formTransaksi').addEventListener('submit', function(e) {
            ...
            if (!fotoInput.files.length) {
                errorMessages.push('Dokumentasi bukti pengeluaran wajib diupload');
                isValid = false;
            }
